...
// copy from https://github.com/xinabox/pxt-od01 thanks
// 6x8 font
...
//% color=#27b0ba icon="\uf26c" block="SSD1306"
...
　 function unshowString(s: string, col: number, row: number, color: number = 1) {
       ...
       if (_cy == 0 && _cx == 0){
        ...
        for (let n = 0; n < s.length; n++) {
            if(flag == 1){
                ...
                char(s.charAt(n), _cx, _cy-1, 1)
               
                
                
                
               
                 //ここを文字サイズが大の時正しく改行できるよう改良
    ...
    */
     ...
     */
    //% blockId="OLED12864_I2C_ON" block=" 電源 %on"
    //% on.defl=1
